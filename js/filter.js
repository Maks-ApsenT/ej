...
function getTableWithFilter2(url) {
    loader.display();
    $.ajax({
        url: url,
        type: 'post',
...
function parseFilterFields2(url) {
...
$(function () {
    ...
    loader.display();
    $.post('ajax/ajax.php', {page: name}, function (data) {
